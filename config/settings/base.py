...
LOCAL_APPS = [
    "wab.cores.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "wab.contrib.sites.migrations"}
...
ADMINS = [("""Bin Nguyen""", "bin-nguyen@example.com")]
...
JWT_AUTH = {
    ...
    "wab.utils.jwt_response_payload_handler.jwt_response_payload_handler",
